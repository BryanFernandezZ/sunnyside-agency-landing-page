...
<body onload="config()" onresize="config()">
  ...
  <div class="container">
    ...
    <article>
      ...
      <div class="title">
        <div class="triangule" id="triangule"></div>
    ...
    <section class="section-main">
        ...
        <div class="image-sentences">
          <div class="sentences">
            <span class="s-1">Transform your brand</span>
            <p class="s-2">We are a full-service creative agency specializing in helping brands grow fast.
              Engage your clients through compelling visuals that do most of the marketing for you.</p>
            <span class="s-3-1">Learn more</span>
          </div>
        </div>

        <div class="image-egg"></div>



        <div class="image-coup"></div>

        <div class="image-sentences">
          <div class="sentences">
            <span class="s-1">Stand out to the right audience</span>
            <p class="s-2"> Using a collaborative formula of designers, researchers, photographers, videographers, and
              copywriters, we’ll build and extend your brand in digital places. </p>
            <span class="s-3-2">Learn more</span>
          </div>
        </div>


        <div class="image-graphic">
          <div class="image-graphic-content">
        ...
        <div class="image-orange">
          <div class="image-orange-content">
      ...
      <div class="person-container">
        <div class="person-item">
          ...
          <p>We put our trust in Sunnyside and they delivered, making sure our needs were met and deadlines were always
            hit.</p>
          <div class="person-item-description">
            <span class="person-name">Emily R.</span>
            <span class="person-role">Marketing Director</span>
          </div>
        </div>
        <div class="person-item">
          ...
          <div class="person-item-description">
            <span class="person-name">Thomas S.</span>
            <span class="person-role">Chief Operating Officer</span>
          </div>
        </div>
        <div class="person-item">
          ...
          <div class="person-item-description">
            <span class="person-name">Jennie F.</span>
            <span class="person-role">Business Owner</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="images-bottom">
      <div class="row">
        <img class="image" src="./images/desktop/image-gallery-milkbottles.jpg" alt="">
        <img class="image" src="./images/desktop/image-gallery-orange.jpg" alt="">
      </div>
      <div class="row">
        <img class="image" src="./images/desktop/image-gallery-cone.jpg" alt="">
        <img class="image" src="./images/desktop/image-gallery-sugarcubes.jpg" alt="">
      </div>
    </section>
    ...
    <footer>
      ...
      <div class="attribution">
        <span>Coded by &nbsp;<a href="#">Bryan Fernández</a>.</span>
...
<script src="https://kit.fontawesome.com/550ac71648.js" crossorigin="anonymous"></script>
